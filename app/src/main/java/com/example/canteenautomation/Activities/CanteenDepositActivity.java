...
public class CanteenDepositActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_canteen_deposit);
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()) {
                                ...
                                Toast.makeText(CanteenDepositActivity.this, "Amount Added..!", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                            else{
                                Toast.makeText(CanteenDepositActivity.this, "Email not found..!", Toast.LENGTH_SHORT).show();
                            }
    ...
    private void initAll() {
        email=findViewById(R.id.canteen_deposit_email);
        depositeAmount=findViewById(R.id.canteen_deposit_amount);
        depositBtn=findViewById(R.id.canteen_deposit_btn);
        progressBar=findViewById(R.id.canteen_deposit_progressBar);
        progressBar.setVisibility(View.GONE);
